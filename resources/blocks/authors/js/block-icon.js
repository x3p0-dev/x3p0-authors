...
// @link https://fonts.google.com/icons?icon.query=patient+li&icon.size=24&icon.color=%235f6368&icon.set=Material+Symbols&selected=Material+Symbols+Rounded:patient_list:FILL@1;wght@400;GRAD@0;opsz@24&icon.style=Rounded
export default (
