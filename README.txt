...
Tags: block, blocks, gutenberg, authors, list
...
Please see the `changelog.md` file included with the plugin file.  Or, you can view the [online change log](https://github.com/x3p0-dev/x3p0-authors/blob/master/CHANGELOG.md).
